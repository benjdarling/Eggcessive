...
public unsafe struct JiggleTreeJobData : IEquatable<JiggleTreeJobData> {
    ...
    public override int GetHashCode() {
        unchecked {
            int hash = 17;
            hash = hash * 31 + rootID;
            hash = hash * 31 + pointCount.GetHashCode();
            hash = hash * 31 + transformIndexOffset.GetHashCode();
            hash = hash * 31 + colliderIndexOffset.GetHashCode();
            hash = hash * 31 + colliderCount.GetHashCode();
            hash = hash * 31 + minExtentPosition.GetHashCode();
            hash = hash * 31 + maxExtentPosition.GetHashCode();
            hash = hash * 31 + ((IntPtr)points).GetHashCode();
            hash = hash * 31 + ((IntPtr)parameters).GetHashCode();
            return hash;
        }
    }
